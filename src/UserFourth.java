...
public class UserFourth extends JFrame implements ActionListener, Runnable{
	...
	UserFourth(){
		...
		Timer t = new Timer(1, new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				if( ! typing) {
					l4.setText("UserOne,UserTwo,UserThree");
				}
			}
		});
